...
<img src="https://github.com/hosniadel666/gps-tracking-system/blob/master/resources/images/system_block_diagram.png" width="800" alt="Google Maps Screenshot">

## Circuit Schematic

<img src="https://github.com/hosniadel666/gps-tracking-system/blob/master/resources/images/system_schematic.png" width="800" alt="Google Maps Screenshot">
...
We have made an android application which connects to the TivaC through Bluetooth Module and receives a real time location updates from the TivaC and plots real time coordinates on map and draw the trajectory using Google Maps API as shown in the following GIF.

![Mobile App](https://user-images.githubusercontent.com/35642947/121815329-327a1180-cc76-11eb-9603-d93da0c47ec5.gif)

 ## Trajectory Plotter Python Script
The python script receives a real time location updates from UART0 and store coordinates in array and after reaching our destination it plots Trajectory using gmplot package as shown in the following figure.
 
|<img src="https://user-images.githubusercontent.com/35642947/121815750-3d35a600-cc78-11eb-950f-869874291387.PNG" width="800" height="500" alt="Path Map Screenshot">| 
|:--:| 
| *Trajectory plot generated by Python script on PC* |

 <br />
 <br />
 
|<img src="https://user-images.githubusercontent.com/35642947/121815748-3a3ab580-cc78-11eb-8d23-0b0551188841.PNG" width="800" height="500" alt="Google Maps Screenshot">| 
|:--:| 
| *Trajectoy on Google Maps* |
